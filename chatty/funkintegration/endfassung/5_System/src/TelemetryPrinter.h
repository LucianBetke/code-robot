...
//
// Der Printer schreibt nicht mehr fest auf Serial, sondern auf
// ein uebergebenes Print-Ziel. Am vorderen Nano ist das
// TelemetryOutput, das jede #-Zeile zusaetzlich an den Funk-
// sender gibt. Die Formatierung bleibt an einer Stelle, es
// entsteht kein zweiter Ausgabepfad.
class TelemetryPrinter
{
public:
    explicit TelemetryPrinter(Print& out);
